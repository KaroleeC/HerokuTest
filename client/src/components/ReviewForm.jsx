          ...
          <div className="card-body text-center">
            <form onChange={this.onSelect} name="food">
              ...
              <div style={{marginTop: '15px'}} >
                <textarea className="input-group-text" style={{backgroundColor: '#fff'}} name="comment" id="textarea" cols="30" rows="3" onChange={this.onChange} placeholder="Leave a comment" ></textarea>
              </div>
